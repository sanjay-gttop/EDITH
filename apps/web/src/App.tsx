  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col font-sans">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-sm font-semibold uppercase tracking-wider text-slate-300">
                Ambulance Allocation Fleet ({DEMO_AMBULANCES.length} Units Tracked)
              </h2>
            </div>
      ...
      <footer className="border-t border-slate-800 bg-slate-900/60 py-3 px-4 text-center text-xs text-slate-500">
        ResQSync // Command — Offline-First Disaster Resource Coordination — Milestone 1 Foundation
      </footer>
    </div>
  );
}
